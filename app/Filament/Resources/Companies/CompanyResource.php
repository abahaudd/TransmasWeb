 ...
 *
 * Purpose:
 * - Registers CRUD pages in Filament for the business's own organizational
 *   entities (Company / Branch / Warehouse / Factory / Office), distinct
 *   from the Customer resource.
