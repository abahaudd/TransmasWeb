...
class ListManagers extends ListRecords
{
    ...
    {
        return [
            Action::make('addNewManager')
                ->label('Add New Manager')
                ->modalHeading('Add New Manager')
                ->modalDescription('Create a manager account with minimal details. Role assignment is handled automatically.')
                ->modalWidth('4xl')
                ->form([
                    Grid::make(2)
                        ->schema([
