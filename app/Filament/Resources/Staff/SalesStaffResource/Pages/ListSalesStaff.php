...
class ListSalesStaff extends ListRecords
{
    ...
    {
        return [
            Action::make('addNewSalesStaff')
                ->label('Add New Sales Staff')
                ->modalHeading('Add New Sales Staff')
                ->modalDescription('Create a sales staff account with minimal details. Role assignment is handled automatically.')
                ->modalWidth('4xl')
                ->form([
                    Grid::make(2)
                        ->schema([
