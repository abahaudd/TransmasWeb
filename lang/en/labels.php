...
return [
    ...
    */
    ...
    'service' => [
        ...
        'workflow_description' => 'The ordered steps this service runs. Drag to reorder — order becomes the run sequence. A step can be a single task or a whole service component.',
        'category' => 'Category',
        'code_helper' => 'Auto-suggested from the category and name — feel free to edit.',
        'description' => 'Description',
        'cost' => 'Cost',
        'cost_helper' => 'Auto-calculated as the sum of the selected tasks / service components below. Adjust manually if needed.',
        'price' => 'Price',
        'add_step' => 'Add step',
        'step' => 'Task / Service Component',
        'quick_add_heading' => 'Quick Add Task / Service Component',
        'quick_add_type' => 'Add As',
